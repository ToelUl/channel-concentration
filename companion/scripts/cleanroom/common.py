...
def candidate_run(run_root: Path | None = None, *, project: Path = PROJECT) -> CandidateRun:
    ...
    if root.exists():
        ...
        for source_root in (frozen, project / "figures"):
        ...
        try:
            ...
            shutil.copytree(project / "figures", stage / "figures", copy_function=shutil.copyfile)
            ...
            record = {
                ...
                "initial_figures_source": "explicit frozen copy; subsequent document reads use run figures",
                "candidate_data": str(root / "data/reproducibility"),
                "profile": "full-reproducibility-successor-candidate-only", "python_observed": sys.version,
