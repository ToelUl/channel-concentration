...
The project MIT License and original attribution are retained. The unchanged baseline contains the software-specific notices and licenses for each producer/reader version.

The original vendored mpmath 1.3.0 license is at
`baseline/software/src/cc_repro/_resources/historical/cc215/repro/evidence/cft/vendor/mpmath-1.3.0.dist-info/LICENSE`.
